...
public abstract class OfficeManagementEntry {
    ...
    @JsonProperty
    public abstract int totalComments();

    @JsonProperty
    public abstract int finishedComments();
    ...
    public abstract static class Builder {
        ...
        @JsonProperty public abstract Builder totalComments(int totalComments);

        @JsonProperty public abstract Builder finishedComments(int totalComments);
